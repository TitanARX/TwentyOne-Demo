	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float mulTime5_g28 = _TimeParameters.x * _TimeScale;
				float mulTime7_g28 = _TimeParameters.x * _TimeFrequency;
				#if defined(_TIMESETTINGS_LINEAR_DEFAULT)
				float staticSwitch1_g28 = _TimeParameters.x;
				#elif defined(_TIMESETTINGS_LINEAR_SCALED)
				float staticSwitch1_g28 = mulTime5_g28;
				#elif defined(_TIMESETTINGS_LINEAR_FPS)
				float staticSwitch1_g28 = ( _TimeScale * ( floor( ( _TimeParameters.x * _TimeFPS ) ) / _TimeFPS ) );
				#elif defined(_TIMESETTINGS_FREQUENCY)
				float staticSwitch1_g28 = ( ( sin( mulTime7_g28 ) * _TimeRange ) + 100.0 );
				#elif defined(_TIMESETTINGS_FREQUENCY_FPS)
				float staticSwitch1_g28 = ( ( _TimeRange * sin( ( _TimeFrequency * ( floor( ( _TimeFPS * _TimeParameters.x ) ) / _TimeFPS ) ) ) ) + 100.0 );
				#elif defined(_TIMESETTINGS_CUSTOM_VALUE)
				float staticSwitch1_g28 = _TimeValue;
				#else
				float staticSwitch1_g28 = _TimeParameters.x;
				#endif
				float3 rotatedValue8_g27 = RotateAroundAxis( float3( _UVRotatePivot ,  0.0 ), float3( IN.texCoord0.xy ,  0.0 ), float3( 0,0,1 ), ( staticSwitch1_g28 * _UVRotateSpeed * PI ) );
				float2 temp_output_74_0 = (rotatedValue8_g27).xy;
				
				float2 temp_output_8_0_g25 = temp_output_74_0;
				
				float3 unpack14_g25 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g25 ), _NormalIntensity );
				unpack14_g25.z = lerp( 1, unpack14_g25.z, saturate(_NormalIntensity) );
				
				float4 Color = ( tex2D( _MainTex, temp_output_74_0 ) * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g25 ).r;
				float3 Normal = unpack14_g25;
...
/*ASEBEGIN
Version=18900
113;292;1374;605;1707.171;688.7667;1.208987;True;True
...
Node;AmplifyShaderEditor.FunctionNode;75;-993.8684,-263.2032;Inherit;False;ShaderTime;5;;28;06a15e67904f217499045f361bad56e7;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;74;-724.2811,-89.85615;Inherit;False;_UVRotate;12;;27;b33a464c10c1c9946bcc807697ca7b43;0;2;28;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;66;23.38802,234.6282;Inherit;False;LitHandler;1;;25;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;67;-5.284546,-87.48749;Inherit;False;TintVertex;-1;;26;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Transform/UV Rotate Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;False;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;74;28;75;0
...
ASEEND*/
//CHKSM=AC6102EEA2CC04204A46B9F1D5CF8EE106D99475