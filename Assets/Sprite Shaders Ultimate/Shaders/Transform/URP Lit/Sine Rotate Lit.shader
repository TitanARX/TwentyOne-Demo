	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float mulTime5_g31 = _TimeParameters.x * _TimeScale;
				float mulTime7_g31 = _TimeParameters.x * _TimeFrequency;
				#if defined(_TIMESETTINGS_LINEAR_DEFAULT)
				float staticSwitch1_g31 = _TimeParameters.x;
				#elif defined(_TIMESETTINGS_LINEAR_SCALED)
				float staticSwitch1_g31 = mulTime5_g31;
				#elif defined(_TIMESETTINGS_LINEAR_FPS)
				float staticSwitch1_g31 = ( _TimeScale * ( floor( ( _TimeParameters.x * _TimeFPS ) ) / _TimeFPS ) );
				...
				float staticSwitch1_g31 = ( ( _TimeRange * sin( ( _TimeFrequency * ( floor( ( _TimeFPS * _TimeParameters.x ) ) / _TimeFPS ) ) ) ) + 100.0 );
				#elif defined(_TIMESETTINGS_CUSTOM_VALUE)
				float staticSwitch1_g31 = _TimeValue;
				#else
				float staticSwitch1_g31 = _TimeParameters.x;
				#endif
				float3 rotatedValue36_g30 = RotateAroundAxis( float3( _SineRotatePivot ,  0.0 ), float3( IN.texCoord0.xy ,  0.0 ), float3( 0,0,1 ), ( sin( ( staticSwitch1_g31 * _SineRotateFrequency ) ) * ( ( _SineRotateAngle / 360.0 ) * PI ) * _SineRotateFade ) );
				float2 temp_output_75_41 = (rotatedValue36_g30).xy;
				
				float2 temp_output_8_0_g28 = temp_output_75_41;
				...
				float4 Color = ( tex2D( _MainTex, temp_output_75_41 ) * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( tex2D( _MainTex, temp_output_75_41 ) * IN.color );
				float3 Normal = unpack14_g28;
...
/*ASEBEGIN
Version=18900
18;507;1374;605;1704.144;431.3309;1.3;True;True
...
Node;AmplifyShaderEditor.FunctionNode;76;-1009.944,-236.3309;Inherit;False;ShaderTime;5;;31;06a15e67904f217499045f361bad56e7;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;75;-756.4595,-160.4873;Inherit;False;_SineRotate;12;;30;af2def15ac77365459ed5b387b6227d9;0;2;51;FLOAT;0;False;32;FLOAT2;0,0;False;1;FLOAT2;41
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Transform/Sine Rotate Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;False;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;75;51;76;0
WireConnection;75;32;71;0
WireConnection;68;0;69;0
WireConnection;68;1;75;41
WireConnection;66;8;75;41
WireConnection;67;1;68;0
WireConnection;15;1;67;0
WireConnection;15;2;66;0
WireConnection;15;3;66;5
ASEEND*/
//CHKSM=34B79ECAFF0D1F6BA1691ABE0A800236AE638BA2