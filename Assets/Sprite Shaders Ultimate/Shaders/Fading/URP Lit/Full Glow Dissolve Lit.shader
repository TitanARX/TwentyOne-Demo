	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 staticSwitch1_g165 = ( texCoord2_g165 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#endif
				float temp_output_5_0_g163 = tex2D( _FullGlowDissolveNoiseTexture, ( staticSwitch1_g165 * _FullGlowDissolveNoiseScale ) ).r;
				float temp_output_61_0_g163 = step( temp_output_5_0_g163 , _FullGlowDissolveFade );
				float temp_output_53_0_g163 = max( ( _FullGlowDissolveFade * _FullGlowDissolveWidth ) , 0.001 );
				float2 uv_MainTex = IN.texCoord0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 temp_output_1_0_g163 = tex2D( _MainTex, uv_MainTex );
				float4 appendResult3_g163 = (float4(( ( (_FullGlowDissolveEdgeColor).rgb * ( temp_output_61_0_g163 - step( temp_output_5_0_g163 , ( ( _FullGlowDissolveFade * ( 1.01 + temp_output_53_0_g163 ) ) - temp_output_53_0_g163 ) ) ) ) + (temp_output_1_0_g163).rgb ) , ( temp_output_1_0_g163.a * temp_output_61_0_g163 )));
				
				float2 temp_output_8_0_g46 = IN.texCoord0.xy;
				
				float3 unpack14_g46 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g46 ), _NormalIntensity );
				unpack14_g46.z = lerp( 1, unpack14_g46.z, saturate(_NormalIntensity) );
				
				float4 Color = ( appendResult3_g163 * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g46 ).r;
				float3 Normal = unpack14_g46;
...
/*ASEBEGIN
Version=18900
105;540;1374;593;1617.978;600.0853;1.222108;True;True
...
Node;AmplifyShaderEditor.FunctionNode;77;-714.8386,-446.0996;Inherit;False;ShaderSpace;5;;165;be729ef05db9c224caec82a3516038dc;0;1;3;SAMPLER2D;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;76;-397.2719,-387.5441;Inherit;False;_FullGlowDissolve;11;;163;8ddf4a66b5da487489c0831f7f85d466;0;3;73;FLOAT2;0,0;False;72;SAMPLER2D;;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;66;23.38802,234.6282;Inherit;False;LitHandler;1;;46;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Fading/Full Glow Dissolve Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;False;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;68;0;69;0
WireConnection;77;3;69;0
WireConnection;76;73;77;0
...
ASEEND*/
//CHKSM=58FB60123761A12707250E32D296F55F91EA7AD2