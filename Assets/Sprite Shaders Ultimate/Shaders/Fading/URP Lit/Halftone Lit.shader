	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord2_g171 = IN.texCoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord22_g171 = IN.texCoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float3 ase_worldPos = IN.ase_texcoord4.xyz;
				float2 texCoord23_g171 = IN.texCoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult28_g171 = (float2(_RectWidth , _RectHeight));
				float4 screenPos = IN.ase_texcoord5;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				#if defined(_SHADERSPACE_UV)
				float2 staticSwitch1_g171 = ( texCoord2_g171 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#elif defined(_SHADERSPACE_UV_RAW)
				float2 staticSwitch1_g171 = texCoord22_g171;
				#elif defined(_SHADERSPACE_OBJECT)
				float2 staticSwitch1_g171 = (IN.ase_texcoord3.xyz).xy;
				#elif defined(_SHADERSPACE_OBJECT_SCALED)
				float2 staticSwitch1_g171 = ( (IN.ase_texcoord3.xyz).xy * (ase_objectScale).xy );
				#elif defined(_SHADERSPACE_WORLD)
				float2 staticSwitch1_g171 = (ase_worldPos).xy;
				#elif defined(_SHADERSPACE_UI_ELEMENT)
				float2 staticSwitch1_g171 = ( texCoord23_g171 * ( appendResult28_g171 / _PixelsPerUnit ) );
				#elif defined(_SHADERSPACE_SCREEN)
				float2 staticSwitch1_g171 = ( ( (ase_screenPosNorm).xy * (_ScreenParams).xy ) / ( _ScreenParams.x / _ScreenWidthUnits ) );
				#else
				float2 staticSwitch1_g171 = ( texCoord2_g171 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#endif
				float2 temp_output_126_0_g169 = staticSwitch1_g171;
				float temp_output_121_0_g169 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_126_0_g169 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
				float2 appendResult11_g170 = (float2(temp_output_121_0_g169 , temp_output_121_0_g169));
				float temp_output_17_0_g170 = length( ( (( ( abs( temp_output_126_0_g169 ) * _HalftoneTiling ) % float2( 1,1 ) )*2.0 + -1.0) / appendResult11_g170 ) );
				float clampResult17_g169 = clamp( saturate( ( ( 1.0 - temp_output_17_0_g170 ) / fwidth( temp_output_17_0_g170 ) ) ) , 0.0 , 1.0 );
				float4 appendResult3_g169 = (float4((temp_output_1_0_g169).rgb , ( temp_output_1_0_g169.a * (( _HalftoneInvert )?( ( 1.0 - clampResult17_g169 ) ):( clampResult17_g169 )) )));
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 staticSwitch1_g171 = texCoord22_g171;
				#elif defined(_SHADERSPACE_OBJECT)
				float2 staticSwitch1_g171 = (IN.ase_texcoord5.xyz).xy;
				#elif defined(_SHADERSPACE_OBJECT_SCALED)
				float2 staticSwitch1_g171 = ( (IN.ase_texcoord5.xyz).xy * (ase_objectScale).xy );
				#elif defined(_SHADERSPACE_WORLD)
				float2 staticSwitch1_g171 = (ase_worldPos).xy;
				#elif defined(_SHADERSPACE_UI_ELEMENT)
				float2 staticSwitch1_g171 = ( texCoord23_g171 * ( appendResult28_g171 / _PixelsPerUnit ) );
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				float2 staticSwitch1_g171 = texCoord22_g171;
				#elif defined(_SHADERSPACE_OBJECT)
				float2 staticSwitch1_g171 = (IN.ase_texcoord2.xyz).xy;
				#elif defined(_SHADERSPACE_OBJECT_SCALED)
				float2 staticSwitch1_g171 = ( (IN.ase_texcoord2.xyz).xy * (ase_objectScale).xy );
				#elif defined(_SHADERSPACE_WORLD)
				float2 staticSwitch1_g171 = (ase_worldPos).xy;
				#elif defined(_SHADERSPACE_UI_ELEMENT)
				float2 staticSwitch1_g171 = ( texCoord23_g171 * ( appendResult28_g171 / _PixelsPerUnit ) );
...
/*ASEBEGIN
Version=18900
0;0;1920;1019;1489.644;812.2935;1.124337;True;True
...
Node;AmplifyShaderEditor.FunctionNode;82;-707.1052,-442.3865;Inherit;False;ShaderSpace;5;;171;be729ef05db9c224caec82a3516038dc;0;1;3;SAMPLER2D;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;81;-380.5668,-384.7888;Inherit;False;_Halftone;11;;169;ca4cfbb80c2060a468153c564b58606b;0;2;126;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
WireConnection;82;3;69;0
WireConnection;81;126;82;0
...
ASEEND*/
//CHKSM=5481D49DA3B93E7C1724EB199210C0596210B415