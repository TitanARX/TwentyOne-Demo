...
Shader "Sprite Shaders Ultimate/URP Lit/Fading/Custom Fade Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _CustomFadeNoiseTexture;
			sampler2D _MaskMap;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord58_g38 = IN.texCoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_57_0_g38 = texCoord58_g38;
				float4 tex2DNode3_g38 = tex2D( _CustomFadeFadeMask, temp_output_57_0_g38 );
				float clampResult37_g38 = clamp( ( ( ( IN.ase_color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g38.r + ( tex2D( _CustomFadeNoiseTexture, ( temp_output_57_0_g38 * _CustomFadeNoiseScale ) ).r * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
				float4 appendResult13_g38 = (float4(( float4( (IN.ase_color).rgb , 0.0 ) * temp_output_1_0_g38 ).rgb , ( temp_output_1_0_g38.a * pow( clampResult37_g38 , ( _CustomFadeSmoothness / max( tex2DNode3_g38.r , 0.05 ) ) ) * _CustomFadeAlpha )));
				...
				float4 Color = appendResult13_g38;
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 temp_output_57_0_g38 = texCoord58_g38;
				float4 tex2DNode3_g38 = tex2D( _CustomFadeFadeMask, temp_output_57_0_g38 );
				float clampResult37_g38 = clamp( ( ( ( IN.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g38.r + ( tex2D( _CustomFadeNoiseTexture, ( temp_output_57_0_g38 * _CustomFadeNoiseScale ) ).r * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
				float4 appendResult13_g38 = (float4(( float4( (IN.color).rgb , 0.0 ) * temp_output_1_0_g38 ).rgb , ( temp_output_1_0_g38.a * pow( clampResult37_g38 , ( _CustomFadeSmoothness / max( tex2DNode3_g38.r , 0.05 ) ) ) * _CustomFadeAlpha )));
...
/*ASEBEGIN
Version=18800
72;204;1374;815;628.2234;259.4253;1;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;69;-975.6506,-332.3375;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;68;-568.8513,-169.1072;Inherit;True;Property;_TextureSample1;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;73;-145.0369,-65.22834;Inherit;False;_CustomFade;5;;38;09a17a2b3ff778e4baeae7d542f88dd6;0;3;57;FLOAT2;0,0;False;56;SAMPLER2D;;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;295.6955,138.9342;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Fading/Custom Fade Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=CEEBC7478020FDF8BEF78B14E3B811974C341F67