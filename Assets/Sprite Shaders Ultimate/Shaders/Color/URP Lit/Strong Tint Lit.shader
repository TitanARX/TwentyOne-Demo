...
Shader "Sprite Shaders Ultimate/URP Lit/Color/Strong Tint Lit"
{
	Properties
	{
		...
		[ASEEnd]_StrongTintContrast("Strong Tint: Contrast", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_1_0_g19 = tex2D( _MainTex, uv_MainTex );
				float4 break2_g20 = temp_output_1_0_g19;
				float temp_output_9_0_g21 = max( _StrongTintContrast , 0.0 );
				float3 lerpResult7_g19 = lerp( (temp_output_1_0_g19).rgb , ( pow( ( ( ( break2_g20.x + break2_g20.y + break2_g20.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g21 ) , 0.0 ) ) ) , temp_output_9_0_g21 ) * (_StrongTintTint).rgb ) , _StrongTintFade);
				float4 appendResult9_g19 = (float4(lerpResult7_g19 , (temp_output_1_0_g19).a));
				
				float2 temp_output_8_0_g22 = IN.texCoord0.xy;
				...
				float4 Color = ( appendResult9_g19 * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult9_g19 * IN.color );
				float3 Normal = unpack14_g22;
...
/*ASEBEGIN
Version=18800
102;22;1338;656;550.722;495.5242;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;67;-42.47076,-232.2997;Inherit;False;_StrongTint;5;;19;967b1b32eaf82fc44b4c41ea1dda1de8;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;66;220.6745,159.7954;Inherit;False;LitHandler;1;;22;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;68;234.7509,-72.4296;Inherit;False;TintVertex;-1;;23;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;506.5879,57.29841;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Color/Strong Tint Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=CB34520CE30124DEDAC561FC45043F327DD9F927