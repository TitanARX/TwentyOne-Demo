...
Shader "Sprite Shaders Ultimate/URP Lit/Color/Split Toning Lit"
{
	Properties
	{
		...
		[ASEEnd]_SplitToningShift("Split Toning: Shift", Range( -1 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break2_g32 = temp_output_1_0_g31;
				float temp_output_3_0_g31 = ( ( break2_g32.x + break2_g32.y + break2_g32.z ) / 3.0 );
				float clampResult25_g31 = clamp( ( ( ( ( temp_output_3_0_g31 + _SplitToningShift ) - 0.5 ) * _SplitToningBalance ) + 0.5 ) , 0.0 , 1.0 );
				float3 lerpResult6_g31 = lerp( (_SplitToningShadowsColor).rgb , (_SplitToningHighlightsColor).rgb , clampResult25_g31);
				float temp_output_9_0_g33 = max( _SplitToningContrast , 0.0 );
				float saferPower7_g33 = max( ( temp_output_3_0_g31 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g33 ) , 0.0 ) ) ) , 0.0001 );
				float3 lerpResult11_g31 = lerp( (temp_output_1_0_g31).rgb , ( lerpResult6_g31 * pow( saferPower7_g33 , temp_output_9_0_g33 ) ) , _SplitToningFade);
				float4 appendResult18_g31 = (float4(lerpResult11_g31 , temp_output_1_0_g31.a));
				...
				float4 Color = ( appendResult18_g31 * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult18_g31 * IN.color );
				float3 Normal = unpack14_g34;
...
/*ASEBEGIN
Version=18800
243;136;1331;560;714.9086;487.2967;1.334285;True;True
...
Node;AmplifyShaderEditor.FunctionNode;75;-18.04844,-227.0832;Inherit;False;_SplitToning;5;;31;6b87c8196f94bcd478491aaa714b31ef;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;506.5879,57.29841;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Color/Split Toning Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=BB3BED20B5730414FEF08A59F1E339264F7EEAEF