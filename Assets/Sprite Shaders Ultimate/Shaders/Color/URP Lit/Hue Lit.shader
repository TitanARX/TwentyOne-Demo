...
Shader "Sprite Shaders Ultimate/URP Lit/Color/Hue Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_2_0_g37 = tex2D( _MainTex, uv_MainTex );
				float3 hsvTorgb1_g37 = RGBToHSV( temp_output_2_0_g37.rgb );
				float3 hsvTorgb3_g37 = HSVToRGB( float3(( hsvTorgb1_g37.x + _Hue ),hsvTorgb1_g37.y,hsvTorgb1_g37.z) );
				float4 appendResult8_g37 = (float4(hsvTorgb3_g37 , temp_output_2_0_g37.a));
				
				float2 temp_output_8_0_g35 = IN.texCoord0.xy;
				
				float3 unpack14_g35 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g35 ), _NormalIntensity );
				unpack14_g35.z = lerp( 1, unpack14_g35.z, saturate(_NormalIntensity) );
				
				float4 Color = ( appendResult8_g37 * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g35 ).r;
				float3 Normal = unpack14_g35;
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult8_g37 * IN.color );
				float3 Normal = unpack14_g35;
...
/*ASEBEGIN
Version=18900
28;218;1374;707;1344.436;706.5887;1.634285;True;True
...
Node;AmplifyShaderEditor.FunctionNode;77;-17.39659,-208.1317;Inherit;False;_Hue;5;;37;0bae267a40388e6498a395bd27428bc6;0;1;2;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;66;220.6745,159.7954;Inherit;False;LitHandler;1;;35;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;68;234.7509,-72.4296;Inherit;False;TintVertex;-1;;36;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;506.5879,57.29841;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Color/Hue Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;False;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=0A8D43AFADD9BA67C7DF996E21B184C12C1806D0