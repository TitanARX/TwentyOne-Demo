...
Shader "Sprite Shaders Ultimate/URP Lit/Color/Saturation Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_1_0_g40 = tex2D( _MainTex, uv_MainTex );
				float4 break2_g41 = temp_output_1_0_g40;
				float3 temp_cast_1 = (( ( break2_g41.x + break2_g41.y + break2_g41.z ) / 3.0 )).xxx;
				float3 lerpResult5_g40 = lerp( temp_cast_1 , (temp_output_1_0_g40).rgb , _Saturation);
				float4 appendResult8_g40 = (float4(lerpResult5_g40 , temp_output_1_0_g40.a));
				
				float2 temp_output_8_0_g42 = IN.texCoord0.xy;
				
				float3 unpack14_g42 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g42 ), _NormalIntensity );
				unpack14_g42.z = lerp( 1, unpack14_g42.z, saturate(_NormalIntensity) );
				
				float4 Color = ( appendResult8_g40 * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g42 ).r;
				float3 Normal = unpack14_g42;
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult8_g40 * IN.color );
				float3 Normal = unpack14_g42;
...
/*ASEBEGIN
Version=18900
78;256;1374;707;1344.436;696.7831;1.634285;True;True
...
Node;AmplifyShaderEditor.FunctionNode;78;-23.93375,-190.1546;Inherit;False;_Saturation;5;;40;d00cab46f082e684d9395d44e5a9f33a;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;66;220.6745,159.7954;Inherit;False;LitHandler;1;;42;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;68;234.7509,-72.4296;Inherit;False;TintVertex;-1;;43;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;506.5879,57.29841;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Color/Saturation Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;False;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=13347BB027E4392986A3330A3487BC4197A97807