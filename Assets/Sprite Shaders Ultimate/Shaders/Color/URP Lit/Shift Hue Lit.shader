	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 temp_output_34_0_g42 = (temp_output_1_0_g42).rgb;
				float mulTime5_g44 = _TimeParameters.x * _TimeScale;
				float mulTime7_g44 = _TimeParameters.x * _TimeFrequency;
				#if defined(_TIMESETTINGS_LINEAR_DEFAULT)
				float staticSwitch1_g44 = _TimeParameters.x;
				#elif defined(_TIMESETTINGS_LINEAR_SCALED)
				float staticSwitch1_g44 = mulTime5_g44;
				#elif defined(_TIMESETTINGS_LINEAR_FPS)
				float staticSwitch1_g44 = ( _TimeScale * ( floor( ( _TimeParameters.x * _TimeFPS ) ) / _TimeFPS ) );
				...
				float staticSwitch1_g44 = ( ( _TimeRange * sin( ( _TimeFrequency * ( floor( ( _TimeFPS * _TimeParameters.x ) ) / _TimeFPS ) ) ) ) + 100.0 );
				#elif defined(_TIMESETTINGS_CUSTOM_VALUE)
				float staticSwitch1_g44 = _TimeValue;
				#else
				float staticSwitch1_g44 = _TimeParameters.x;
				#endif
				float3 hsvTorgb15_g42 = RGBToHSV( temp_output_34_0_g42 );
				float3 hsvTorgb19_g42 = HSVToRGB( float3(( ( staticSwitch1_g44 * _ShiftHueSpeed ) + hsvTorgb15_g42.x ),hsvTorgb15_g42.y,hsvTorgb15_g42.z) );
				float2 uv_ShiftHueShaderMask = IN.texCoord0.xy * _ShiftHueShaderMask_ST.xy + _ShiftHueShaderMask_ST.zw;
				float4 tex2DNode3_g43 = tex2D( _ShiftHueShaderMask, uv_ShiftHueShaderMask );
				float3 lerpResult33_g42 = lerp( temp_output_34_0_g42 , hsvTorgb19_g42 , ( _ShiftHueFade * ( tex2DNode3_g43.r * tex2DNode3_g43.a ) ));
				float4 appendResult6_g42 = (float4(lerpResult33_g42 , temp_output_1_0_g42.a));
				
				float2 temp_output_8_0_g40 = IN.texCoord0.xy;
				
				float3 unpack14_g40 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g40 ), _NormalIntensity );
				unpack14_g40.z = lerp( 1, unpack14_g40.z, saturate(_NormalIntensity) );
				
				float4 Color = ( appendResult6_g42 * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g40 ).r;
				float3 Normal = unpack14_g40;
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult6_g42 * IN.color );
				float3 Normal = unpack14_g40;
...
/*ASEBEGIN
Version=18900
106;182;1374;635;1115.834;674.5062;1.555538;True;True
...
Node;AmplifyShaderEditor.FunctionNode;76;-230.7326,-441.1755;Inherit;False;ShaderTime;5;;44;06a15e67904f217499045f361bad56e7;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;75;-14.51283,-175.9564;Inherit;False;_ShiftHue;12;;42;96c4ce2b4a870d842a5631d1a2ef1fe5;0;2;35;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;66;220.6745,159.7954;Inherit;False;LitHandler;1;;40;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;68;234.7509,-72.4296;Inherit;False;TintVertex;-1;;41;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;506.5879,57.29841;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Color/Shift Hue Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;False;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
WireConnection;69;0;70;0
WireConnection;75;35;76;0
...
ASEEND*/
//CHKSM=33C86922967389863ED36C14B43F311DA4974141