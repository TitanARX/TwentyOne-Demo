...
Shader "Sprite Shaders Ultimate/URP Lit/Color/Add Color Lit"
{
	Properties
	{
		...
		[ASEEnd]_AddColorContrast("Add Color: Contrast", Float) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_1_0_g23 = tex2D( _MainTex, uv_MainTex );
				float4 break2_g25 = temp_output_1_0_g23;
				float temp_output_9_0_g24 = max( _AddColorContrast , 0.0 );
				float4 appendResult6_g23 = (float4(( ( (_AddColorColor).rgb * pow( ( ( ( break2_g25.x + break2_g25.y + break2_g25.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g24 ) , 0.0 ) ) ) , temp_output_9_0_g24 ) * _AddColorFade ) + (temp_output_1_0_g23).rgb ) , temp_output_1_0_g23.a));
				...
				float4 Color = ( appendResult6_g23 * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult6_g23 * IN.color );
				float3 Normal = unpack14_g26;
...
/*ASEBEGIN
Version=18800
189;220;1338;706;1185.833;561.7298;1.555538;True;True
...
Node;AmplifyShaderEditor.FunctionNode;71;-18.22254,-184.2101;Inherit;False;_AddColor;5;;23;e6726d248ffc4924b820ee13a62ca999;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;15;506.5879,57.29841;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Color/Add Color Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=93D066492EB5F2DE6C2F70209341C6F1DD36E693