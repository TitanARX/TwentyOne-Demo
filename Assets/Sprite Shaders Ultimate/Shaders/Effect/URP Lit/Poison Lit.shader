	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float staticSwitch1_g435 = _TimeParameters.x;
				#endif
				float temp_output_41_0_g237 = staticSwitch1_g435;
				...
				float2 staticSwitch1_g231 = ( texCoord2_g231 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#endif
				float saferPower19_g237 = max( abs( ( ( ( tex2D( _PoisonNoiseTexture, ( ( ( temp_output_41_0_g237 * _PoisonNoiseSpeed ) + staticSwitch1_g231 ) * _PoisonNoiseScale ) ).r + ( temp_output_41_0_g237 * _PoisonShiftSpeed ) ) % 1.0 ) + -0.5 ) ) , 0.0001 );
				float3 temp_output_24_0_g237 = (_PoisonColor).rgb;
				float2 uv_MainTex = IN.texCoord0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 temp_output_1_0_g237 = tex2D( _MainTex, uv_MainTex );
				float3 temp_output_28_0_g237 = (temp_output_1_0_g237).rgb;
				float4 break2_g239 = float4( temp_output_28_0_g237 , 0.0 );
				float3 lerpResult32_g237 = lerp( temp_output_28_0_g237 , ( temp_output_24_0_g237 * ( ( break2_g239.x + break2_g239.y + break2_g239.z ) / 3.0 ) ) , ( _PoisonFade * _PoisonRecolorFactor ));
				float4 appendResult27_g237 = (float4(( ( max( pow( saferPower19_g237 , _PoisonDensity ) , 0.0 ) * temp_output_24_0_g237 * _PoisonFade * _PoisonNoiseBrightness ) + lerpResult32_g237 ) , temp_output_1_0_g237.a));
				
				float2 temp_output_8_0_g236 = IN.texCoord0.xy;
				
				float3 unpack14_g236 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g236 ), _NormalIntensity );
				unpack14_g236.z = lerp( 1, unpack14_g236.z, saturate(_NormalIntensity) );
				
				float4 Color = ( appendResult27_g237 * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g236 ).r;
				float3 Normal = unpack14_g236;
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult27_g237 * IN.color );
				float3 Normal = unpack14_g236;
...
/*ASEBEGIN
Version=18900
0;0;1920;1019;1737.983;406.4366;1.500533;True;True
...
Node;AmplifyShaderEditor.FunctionNode;91;-705.616,-106.33;Inherit;False;ShaderSpace;5;;231;be729ef05db9c224caec82a3516038dc;0;1;3;SAMPLER2D;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;93;-672.6047,-235.3759;Inherit;False;ShaderTime;11;;435;06a15e67904f217499045f361bad56e7;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;92;-352.2452,-68.37054;Inherit;False;_Poison;18;;237;22d5850153b7c6b44a14f0e4e0d08787;0;4;41;FLOAT;0;False;40;FLOAT2;0,0;False;3;SAMPLER2D;;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;22;-63.6362,70.99575;Inherit;False;TintVertex;-1;;235;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;86;-68.50143,156.8532;Inherit;False;LitHandler;1;;236;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;83;211.4418,70.685;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Effect/Poison Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;False;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
WireConnection;92;41;93;0
WireConnection;92;40;91;0
...
ASEEND*/
//CHKSM=AD37B1E829796FB4E578AA0507BC1793E498DAFB