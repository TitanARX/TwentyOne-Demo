...
Shader "Sprite Shaders Ultimate/URP Lit/Interactive/Squish Lit"
{
	Properties
	{
		...
		[ASEEnd]_SquishFlip("Squish: Flip", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput vert ( VertexInput v  )
			{
				...
				float2 break77_g194 = v.uv0.xy;
				float2 appendResult72_g194 = (float2(( _SquishStretch * ( break77_g194.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g194.y + _SquishFlip ) * -_SquishSquish )));
				...
				#endif
				float3 vertexValue = float3( appendResult72_g194 ,  0.0 );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 temp_output_8_0_g193 = IN.texCoord0.xy;
				
				float3 unpack14_g193 = UnpackNormalScale( tex2D( _NormalMap, temp_output_8_0_g193 ), _NormalIntensity );
				unpack14_g193.z = lerp( 1, unpack14_g193.z, saturate(_NormalIntensity) );
				
				float4 Color = ( tex2D( _MainTex, uv_MainTex ) * IN.ase_color );
				float Mask = tex2D( _MaskMap, temp_output_8_0_g193 ).r;
				float3 Normal = unpack14_g193;
...
/*ASEBEGIN
Version=18800
102;22;1338;656;1513.872;324.0544;1.3;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;25;-836.8448,-83.54922;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;89;-439.869,274.9094;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;22;-63.6362,70.99575;Inherit;False;TintVertex;-1;;192;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;86;-68.50143,156.8532;Inherit;False;LitHandler;1;;193;851662d67a92ce04d84817ff63c501f2;0;1;8;FLOAT2;0,0;False;2;COLOR;0;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;90;-104.6723,372.0949;Inherit;False;_Squish;5;;194;6d6a73cc3433bad4186f7028cad3d98c;0;1;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;83;211.4418,70.685;Float;False;True;-1;2;SpriteShadersUltimate.SingleShaderGUI;0;12;Sprite Shaders Ultimate/URP Lit/Interactive/Squish Lit;199187dac283dbe4a8cb1ea611d70c58;True;Sprite Lit;0;0;Sprite Lit;6;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;True;2;5;False;-1;10;False;-1;3;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;1;Vertex Position;1;0;3;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=69F09DCEF8F60E304ADB9E86B93626169258B57A